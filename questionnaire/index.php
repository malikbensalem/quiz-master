			...
			<div class="row">
				<div class="col-md-4" >
					...
					<div class="btn-group-vertical btn-block">
						<a class="btn btn-lg btn-block btn-outline-info active">Action <i class="fa-solid fa-clapperboard"></i></a>
						<button class="btn btn-lg btn-block btn-outline-dark" id="create-q">Create questionnaire <i class="fa-solid fa-plus"></i></button> 
					</div>
					<?}?>
					<?if(hasAccess('2')){?>
					<div class="btn-group-vertical btn-block" id="statuses">
						<a class="btn btn-lg btn-block btn-outline-info active">Status <i class="fa-solid fa-asterisk"></i></a>
						<button class="btn btn-lg btn-block btn-outline-dark" data-btn-status="1">Published <i class="fa-solid fa-clipboard-check"></i></button>
						<button class="btn btn-lg btn-block btn-outline-dark"data-btn-status="2">Drafts <i class="fa-solid fa-pen-to-square"></i></button>
					</div>
					<?}?>
					<div class="btn-group-vertical btn-block">
						<a class="btn btn-lg btn-block btn-outline-info active">Filters <i class="fa-solid fa-filter"></i></a>
				...
				<div class="col-md-8">
					<div class="table-responsive">
						<table class="table table-striped " id="tbl-questionnaire">
							<thead><th>Title</th><th>Subject</th><?if(!hasAccess(2)){?><th>Passed</th><?}?><th>Assigned by</th><th>Deadline</th><th>Owned by</th><th>Actions</th></thead>
							<tbody></tbody>
						</table>
					</div>
				</div>
